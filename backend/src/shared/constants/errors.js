...
const ErrorCodes = {
  ...
  // Admin invite errors
  ADMIN_INVITE: {
    NOT_FOUND: 'ADMIN_INVITE_NOT_FOUND',
    ALREADY_USED: 'ADMIN_INVITE_ALREADY_USED',
    EXPIRED: 'ADMIN_INVITE_EXPIRED',
    REVOKED: 'ADMIN_INVITE_REVOKED',
  },
...
const ERROR_CODES = {
  ...
  // Admin auth
  ADMIN_INVALID_SECRET: 'INVALID_ADMIN_SECRET',
  ADMIN_INVALID_INVITE: 'INVALID_INVITE_CODE',
  ADMIN_INVITE_EXPIRED: 'ADMIN_INVITE_EXPIRED',
  ADMIN_INVITE_USED: 'ADMIN_INVITE_ALREADY_USED',
  ADMIN_INVITE_REVOKED: 'ADMIN_INVITE_REVOKED',
  ADMIN_INVITE_EMAIL_MISMATCH: 'INVITE_EMAIL_MISMATCH',
...
const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.ADMIN_INVALID_SECRET]: 'Invalid admin registration secret',
  [ERROR_CODES.ADMIN_INVALID_INVITE]: 'Invalid invite code',
  [ERROR_CODES.ADMIN_INVITE_EXPIRED]: 'Invite code has expired',
  [ERROR_CODES.ADMIN_INVITE_USED]: 'Invite code has already been used',
  [ERROR_CODES.ADMIN_INVITE_REVOKED]: 'Invite code has been revoked',
  [ERROR_CODES.ADMIN_INVITE_EMAIL_MISMATCH]: 'This invite code is restricted to a different email',
  [ERROR_CODES.ADMIN_INVITE_NOT_FOUND]: 'Invite not found',
  [ERROR_CODES.NOT_ADMIN_ACCOUNT]: 'Invalid credentials',
};

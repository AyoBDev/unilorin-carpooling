...
#
# Path: infrastructure/environments/production/lambda.tf
#
...
variable "encryption_key" {
  description = "32-byte AES-256 key for encrypting sensitive data at rest"
  type        = string
  sensitive   = true
}
